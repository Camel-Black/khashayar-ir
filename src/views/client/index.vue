...
<div>
    ...
    <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12 " style="padding: 0px;">
        <div class="imgback ">
            <div class=" header">
                <h2 style="font-weight: bold;font-size: 2vw;text-align: right;font-family: Sahel" class="animated fadeInDown delay0.5s">
                    یه برنامه نویس ساده
                </h2>
                <p style="font-size: 1vw;min-font-size:200px;font-family: Sahel" class="animated fadeInDown delay1s">برنامه نویسی باید به گونه ای باشد که ما همگی بشاشیم به خودمان</p>
            </div>
            <div class="sandwich d-block d-sm-none  d-sm-block   d-md-block d-lg-none animated fadeInDown delay1s">
        ...
        <div class="row sidebar" style="margin: 0px;margin-top: 2vw;">
            <div class="col" style="padding-right:3.5vw">
                <ul class="text-right" style="list-style-type: none;">
                    ...
                    <li class="list-item un"><a href="/services" style="color: rgb(255,255,255);font-size: 1.5vw;font-family: Sahel;margin-right: 0.5vw;">خدمات</a><i class="fa fa-suitcase" style="font-size: 1vw;"></i></li>
