        ...
        <div class="row sidebar" style="margin: 0px;margin-top: 2vw;">
            <div class="col" style="padding-right:3.5vw">
                <ul class="text-right" style="list-style-type: none;">
                    ...
                    <li class="list-item active un"><a href="/resume" style="color: #e2935c;font-size: 1.5vw;font-family: Sahel;margin-right: 0.5vw;">نمونه کارها</a><i class="fa fa-check-circle-o" style="font-size: 1vw;"></i></li>
